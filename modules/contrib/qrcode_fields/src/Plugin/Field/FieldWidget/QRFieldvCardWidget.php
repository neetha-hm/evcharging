 ...
 *
 * @FieldWidget(
 *   id = "qrcode_vcard_field_widget",
 *   label = @Translation("QR vCard field widget"),
 *   field_types = {
 *      "qrcode_vcard"
 *   }
 * )
 */
class QRFieldvCardWidget extends WidgetBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $elements['work_phone'] = [
      '#title' => $this->t('Default work phone'),
      '#type' => 'textfield',
      '#default_value' => $this->getSetting('work_phone'),
    ];
    $elements['address'] = [
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $work_phone = $items[$delta]->work_phone ?? $this->getSetting('work_phone');
    ...
    $element['details']['work_phone'] = [
      ...
      '#description' => [
        '#theme' => 'token_tree_link',
        '#token_types' => [$this->fieldDefinition->getTargetEntityTypeId()],
        '#prefix' => $this->t('Enter the work phone of the contact here (e.g., 123456789 or a valid token like [node:field_work_phone]).<br>This field supports tokens:'),
        '#suffix' => $this->t('<br><small>Utilize a maximum of 30 characters, either through standard text or by employing token generation.</small>'),
      ],
    ];
    ...
    $element['details']['title'] = [
      ...
      '#description' => [
        '#theme' => 'token_tree_link',
        '#token_types' => [$this->fieldDefinition->getTargetEntityTypeId()],
        '#prefix' => $this->t('Enter the job title associated with the contact here (e.g., Manager or a valid token like [node:field_organization]).<br>This field supports tokens:'),
        '#suffix' => $this->t('<br><small>Utilize a maximum of 30 characters, either through standard text or by employing token generation.</small>'),
      ],
    ];
  ...
  public function massageFormValues(array $values, array $form, FormStateInterface $form_state) {
    ...
    foreach ($values as $delta => $element) {
      ...
      if ($element['details']['work_phone']) {
        $values[$delta]['work_phone'] = $element['details']['work_phone'];
      }
  ...
  public function settingsSummary() {
    ...
    if ($this->getSetting('work_phone')) {
      $summary[] = $this->t('Default work phone: @work_phone', [
        '@work_phone' => $this->getSetting('work_phone'),
      ]);
    }
    ...
    if ($this->getSetting('title')) {
      $summary[] = $this->t('Default job title: @title', [
