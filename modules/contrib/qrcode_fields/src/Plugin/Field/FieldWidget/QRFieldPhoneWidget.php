 ...
 *
 * @FieldWidget(
 *   id = "qrcode_phone_field_widget",
 *   label = @Translation("QR phone field widget"),
 *   field_types = {
 *      "qrcode_phone"
 *   }
 * )
 */
class QRFieldPhoneWidget extends WidgetBase {
  ...
  /**
   * Constructs a QRFieldPhoneWidget object.
   *
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['details']['phone'] = [
      ...
      '#description' => [
        ...
        '#prefix' => $this->t('Enter the phone number here (e.g.: +19794293446 or valid token like [node:field_phone_number]).<br>This field supports tokens:'),
      ],
    ];
    return $element;
  }
