 ...
 *
 * @Block(
 *   id = "qrcode_phone_block",
 *   admin_label = @Translation("QR phone block"),
 *   category = @Translation("QR Code Fields")
 * )
 */
class QRPhoneBlock extends BlockBase implements ContainerFactoryPluginInterface {
