 ...
 *
 * @Block(
 *   id = "qrcode_vcard_block",
 *   admin_label = @Translation("QR vcard block"),
 *   category = @Translation("QR Code Fields")
 * )
 */
class QRvCardBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['work_phone'] = [
      ...
      '#type' => 'textfield',
      '#default_value' => $config['work_phone'] ?? '',
      '#description' => [
        '#theme' => 'token_tree_link',
        '#token_types' => [],
        '#prefix' => $this->t('This field supports tokens.'),
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    ...
    $this->configuration['work_phone'] = $form_state->getValue('work_phone');
  ...
  public function build() {
    ...
    if ($config['display_text']) {
      $build['fname'] = [
        ...
        '#attributes' => [
          'class' => 'qrcode_vcard-' . $this->pluginId,
        ],
      ];
      $build['lname'] = [
        '#type' => 'html_tag',
      ...
      $build['work_phone'] = [
        '#type' => 'html_tag',
        '#tag' => 'div',
        '#value' => $this->token->replace($config['work_phone']),
        '#attributes' => [
          'class' => 'qrcode_vcard-' . $this->pluginId,
        ],
      ];
