 ...
 *
 * @Block(
 *   id = "qrcode_text_block",
 *   admin_label = @Translation("QR text block"),
 *   category = @Translation("QR Code Fields")
 * )
 */
class QRTextBlock extends BlockBase implements ContainerFactoryPluginInterface {
